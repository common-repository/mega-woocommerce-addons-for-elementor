<?php
	...
	class Widget_mwafe_addon_product_simple extends Widget_Base {
		...
		public function get_title() {
			return __( 'Products Simple', 'woocommerce-addons-elementor' );
		}
		...
		protected function _register_controls() {
			$this->start_controls_section(
				'section_button',
				[
					'label' => __( 'Product Settings', 'woocommerce-addons-elementor' ),
				]
			);

			$this->add_control(
			  'mwae_product_simple_products_count',
			  [
			...
			$this->add_control(
				'mwae_product_simple_sorting_option',
				[
        ...
        $this->start_controls_section(
			'mwae_section_product_simple_grid_layout',
			[
		...
		$this->add_control(
			'mwae_product_simple_grid_column',
			[
		...
		$this->add_control(
            'mwae_show_product_simple_title',
            [
		...
		$this->add_control(
            'mwae_show_product_simple_description',
            [
                'label' => __( 'Show Product Description', 'woocommerce-addons-elementor' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
					'1' => [
						'title' => __( 'Yes', 'woocommerce-addons-elementor' ),
		...
		$this->add_control(
            'mwae_show_product_simple_price',
            [
		...
		$this->add_control(
            'mwae_show_product_simple_rating',
            [
		...
		$this->add_control(
            'mwae_show_product_simple_cart_button',
            [
        ...
        $this->start_controls_section(
            'mwea_section_product_simple_style',
            [
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .product-vertical' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .product-vertical' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
				],
			]
		);
        ...
        $this->add_control(
			'mwea_product_simple_bg_color',
			[
				'label' => __( 'Product Box Color', 'woocommerce-addons-elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#fff',
				'selectors' => [
					'{{WRAPPER}} .product-vertical-inner' => 'background-color: {{VALUE}}',
				]
        ...
        $this->add_control(
			'mwea_product_simple_title_color',
			[
        ...
        $this->add_control(
			'mwea_product_simple_title_hover_color',
			[
        ...
        $this->add_control(
			'mwea_product_simple_desc_color',
			[
				'label' => __( 'Description Color', 'woocommerce-addons-elementor' ),
				'type' => Controls_Manager::COLOR,
				'default'=> '#303133',
				'selectors' => [
					'{{WRAPPER}} .wae-product-vertical-text' => 'color: {{VALUE}};',
				]
        ...
        $this->add_control(
			'mwea_product_simple_price_color',
			[
        ...
        $this->add_control(
			'mwea_product_simple_rating_color',
			[
        ...
        $this->add_control(
			'mwea_product_simple_button_color',
			[
        ...
        $this->add_control(
			'mwea_product_simple_button_text_color',
			[
		...
		$this->add_group_control(
			...
			[
				'name' => 'mwea_product_simple_typography_title',
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'mwea_product_simple_typography_info',
				'label' => __( 'Other Text Typography', 'woocommerce-addons-elementor' ),
				'scheme' => Scheme_Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .wae-product-vertical-text',
			]
		);
		...
		protected function render() {
			...
			$no_product 	= $this->get_settings( 'mwae_product_simple_products_count' );
			$product_sort 	= $this->get_settings( 'mwae_product_simple_sorting_option' );
			$column 		= $this->get_settings( 'mwae_product_simple_grid_column' );
			$align 			= $this->get_settings( 'mwae_product_simple_align');
		...
		<div class="wae-products-vertical">
		<div class="boot-row">
			<?php while ( $products_query->have_posts() ) : $products_query->the_post(); ?>

				<div class="product-vertical <?php echo $column;?>">
				<div class="product-vertical-inner">

				<div class="wae-product-vertical">
					<div class="wae-product-vertical-image">
						<a href="<?php the_permalink();?>">
							<img src="<?php echo wp_get_attachment_image_url(get_post_thumbnail_id(), $settings['image_size'])?>">
						</a>
					</div>
					<div class="wae-product-vertical-text <?php echo $align;?>">

						<?php if( $settings['mwae_show_product_simple_title'] == 1 ):?>
							<h3 class="entry-title heading-three">
								<a href="<?php the_permalink();?>"><?php the_title();?></a>
							</h3>
						<?php endif;?>

						<?php if( $settings['mwae_show_product_simple_price'] == 1 ):?>
							<div class="wae-product-vertical-price-info">
								<span class="wae-product-price"><?php woocommerce_template_single_price();?></span>
							</div>
						<?php endif;?>

						<?php if( $settings['mwae_show_product_simple_description'] == 1 ):?>
								<?php the_excerpt();?>
						<?php endif;?>

						<?php if( $settings['mwae_show_product_simple_rating'] == 1 ):?>
						<?php woocommerce_template_loop_rating();?>
						<?php endif;?>

						<?php if( $settings['mwae_show_product_simple_cart_button'] == 1 ):?>
	...
	add_action( 'elementor/widgets/widgets_registered', function ( $widgets_manager ) {
		$widgets_manager->register_widget_type( new Widget_mwafe_addon_product_simple() );
	} );